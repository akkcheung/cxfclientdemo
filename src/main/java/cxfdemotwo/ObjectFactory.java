 ...
 * generated in the cxfdemotwo package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHiToUser_QNAME = new QName("http://cxfdemoTwo/", "sayHiToUser");
    private final static QName _GetUsersResponse_QNAME = new QName("http://cxfdemoTwo/", "getUsersResponse");
    private final static QName _GetUsers_QNAME = new QName("http://cxfdemoTwo/", "getUsers");
    private final static QName _SayHi_QNAME = new QName("http://cxfdemoTwo/", "sayHi");
    private final static QName _SayHiToUserResponse_QNAME = new QName("http://cxfdemoTwo/", "sayHiToUserResponse");
    private final static QName _SayHiResponse_QNAME = new QName("http://cxfdemoTwo/", "sayHiResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxfdemotwo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "sayHiToUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "getUsersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "getUsers")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "sayHi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "sayHiToUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfdemoTwo/", name = "sayHiResponse")
